...
\begin{table}
	...
	\begin{tabular}{||c | c ||}
		...
		Scenario 2 & Unconstrained capacity
...
\begin{figure}
	...
	\caption{Optimization model results - plant location (red), urea distribution (black) - Base case scenario}
	\label{img_optimizationresults_1}
\end{figure}

The plant capacity was constrained to a maximum of 80 t/h at this first run. An additional scenario with unconstrained
capacity and limited to the Southeast Region was modeled. In this scenario, the optimal region is the Ribeirão Preto one,
with an optimal capacity calculated by the model of 244.9 t/h. Despite the feasibility of this configuration, the 
